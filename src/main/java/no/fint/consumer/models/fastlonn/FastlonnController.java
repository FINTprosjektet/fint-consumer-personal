...
public class FastlonnController {
    ...
    public ResponseEntity getStatus(@PathVariable String id,
        ...
        List<FastlonnResource> result = objectMapper.convertValue(event.getData(), objectMapper.getTypeFactory().constructCollectionType(List.class, FastlonnResource.class));
    ...
    public ResponseEntity postFastlonn(
        ...
        log.info("postFastlonn, Validate: {}, OrgId: {}, Client: {}", validate, orgId, client);
        log.trace("Body: {}", body);
    ...
    public ResponseEntity putFastlonnBySystemId(
        ...
        log.info("putFastlonnBySystemId {}, OrgId: {}, Client: {}", id, orgId, client);
        log.trace("Body: {}", body);
        Event event = new Event(orgId, Constants.COMPONENT, PersonalActions.UPDATE_FASTLONN, client);
