...
public class ArbeidsforholdController {
    ...
    public ResponseEntity getStatus(@PathVariable String id,
        ...
        List<ArbeidsforholdResource> result = objectMapper.convertValue(event.getData(), objectMapper.getTypeFactory().constructCollectionType(List.class, ArbeidsforholdResource.class));
    ...
    public ResponseEntity postArbeidsforhold(
        ...
        log.info("postArbeidsforhold, OrgId: {}, Client: {}", orgId, client);
        log.trace("Body: {}", body);
