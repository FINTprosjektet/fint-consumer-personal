...
public class ArbeidsforholdController {
    ...
    public ResponseEntity getStatus(@PathVariable String id,
        ...
        List<ArbeidsforholdResource> result = objectMapper.convertValue(e.getData(), objectMapper.getTypeFactory().constructCollectionType(List.class, ArbeidsforholdResource.class));
