...
public class PersonalressursController {
    ...
    public ResponseEntity getStatus(@PathVariable String id,
        ...
        List<PersonalressursResource> result = objectMapper.convertValue(e.getData(), objectMapper.getTypeFactory().constructCollectionType(List.class, PersonalressursResource.class));
